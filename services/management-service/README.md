<div align="center">
  <h3 align="center">Management Service</h3>
  <p align="center">
...
```
  docker run --name postgresdb -e POSTGRES_PASSWORD=<password in application.properties> -e POSTGRES_DB=managementservicedb -p 5432:5432 -d postgres:12.6
```
...
```
java -jar build/libs/management-service-0.1.0.jar
```
